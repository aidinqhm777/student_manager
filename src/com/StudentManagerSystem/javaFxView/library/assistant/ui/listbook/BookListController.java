package com.StudentManagerSystem.javaFxView.library.assistant.ui.listbook;
...
public class BookListController implements Initializable {
    ...
    private void handleBookEditOption(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/StudentManagerSystem/javaFxView/library/assistant/ui/addbook/add_book.fxml"));
