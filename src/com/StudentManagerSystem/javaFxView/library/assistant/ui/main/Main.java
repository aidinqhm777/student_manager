...
import com.StudentManagerSystem.javaFxView.library.assistant.exceptions.ExceptionUtil;
...
public class Main extends Application {
    ...
    public void start(Stage stage) throws Exception {
        Parent root = FXMLLoader.load(getClass().getResource("/com/StudentManagerSystem/javaFxView/library/assistant/ui/login/login.fxml"));
