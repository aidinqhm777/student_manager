...
//    find insert delete info from or to btrees indirectly
    ...
    private static void loadBtree_StudentUniID() {
        try {
            studentUniID_btree = (BPlusTree) FileManage.loadBtree_StudentUniID();
    ...
    private static void loadBtree_StudentName() {
        try {
            studentName_btree = (BPlusTree<String, Integer>) FileManage.loadBtree_StudentName();
        } catch (IOException | ClassNotFoundException e) {
            System.out.println(e.toString());
        }
    }
    ...
    private static void loadBtree_StudentLastname() {
        try {
            studentLastname_btree = (BPlusTree<String, Integer>) FileManage.loadBtree_StudentLastName();
        } catch (IOException | ClassNotFoundException e) {
            System.out.println(e.toString());
        }
    }
