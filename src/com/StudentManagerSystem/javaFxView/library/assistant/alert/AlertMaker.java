package com.StudentManagerSystem.javaFxView.library.assistant.alert;
...
public class AlertMaker {
    ...
    private static void styleAlert(Alert alert) {
        ...
        dialogPane.getStylesheets().add(AlertMaker.class.getResource("/com/StudentManagerSystem/javaFxView/library/resources/dark-theme.css").toExternalForm());
