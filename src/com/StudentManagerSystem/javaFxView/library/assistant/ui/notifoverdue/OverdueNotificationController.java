package com.StudentManagerSystem.javaFxView.library.assistant.ui.notifoverdue;
...
import com.StudentManagerSystem.javaFxView.library.assistant.data.model.MailServerInfo;
import com.StudentManagerSystem.javaFxView.library.assistant.database.DataHelper;
import com.StudentManagerSystem.javaFxView.library.assistant.database.DatabaseHandler;
import com.StudentManagerSystem.javaFxView.library.assistant.ui.notifoverdue.emailsender.EmailSenderController;
import com.StudentManagerSystem.javaFxView.library.assistant.ui.settings.Preferences;
...
public class OverdueNotificationController implements Initializable {
    ...
    private void handleSendNotificationAction(ActionEvent event) {
        ...
        Object controller = LibraryAssistantUtil.loadWindow(getClass().getResource("/com/StudentManagerSystem/javaFxView/library/assistant/ui/notifoverdue/emailsender/email_sender.fxml"), "Notify Overdue", null);
        if (controller != null) {
