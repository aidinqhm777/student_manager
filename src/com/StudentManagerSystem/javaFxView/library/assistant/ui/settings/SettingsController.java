package com.StudentManagerSystem.javaFxView.library.assistant.ui.settings;
...
import com.StudentManagerSystem.javaFxView.library.assistant.database.export.DatabaseExporter;
import com.StudentManagerSystem.javaFxView.library.assistant.ui.mail.TestMailController;
...
public class SettingsController implements Initializable {
    ...
    private void handleTestMailAction(ActionEvent event) {
        ...
        if (mailServerInfo != null) {
            TestMailController controller = (TestMailController) LibraryAssistantUtil.loadWindow(getClass().getResource("/com/StudentManagerSystem/javaFxView/library/assistant/ui/mail/test_mail.fxml"), "Test Email", null);
