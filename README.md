...
date = 2014-04-24
updated = 2019-01-1
description = "React to selection changes in the JavaFX TableView. اضافه کردن، تغییر و حذف یک آیتم از جدول و برسی صحت ورودی کاربر ."
...
* اضافه کردن عملکرد به دکمه های **اضافه**، **ویرایش** و **حذف**
* Create a custom **popup dialog** to edit a person.
* ایجاد یک **popup dialog** برای ویرایش یک فرد
* **Validate user input**.
